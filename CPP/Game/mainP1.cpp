// Scenario: You’ve spent almost a full year working at a video game company. So far they haven’t let
// you do anything too interesting, but the higher-ups have finally decided that you get to do something
// exciting:
// Create a small-scale, proof of concept puzzle survival game that runs in the terminal, using C++.
// It isn’t too fancy and it is only the foundation of the game, since it’s meant to only be a proof of
// concept: there is a map in the game containing floors, walls, doors, an exit and of course, a playable
// character. The goal of the game is to reach the end of the level (the exit).
#include <iostream>
#include "Game.h"
