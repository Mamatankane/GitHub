...
AboveWeightEx::AboveWeightEx(double wd): weightDiff(wd){
...
template <class E>
UndervaluedEx<E>:: UndervaluedEx(E* uv, double s): underVal(uv), sum(s){
...
template <class E>
NotFoundEx<E>::NotFoundEx(E * nf): missing(nf){
